...
<div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
    <div class="widget am-cf">
        ...
        <div class="widget-body am-fr">
            ...
            <form class="am-form tpl-form-line-form" action="{{ url('admin/comment/'.$comment->cid) }}" method="post">
                {{ csrf_field() }}
                {{ method_field('PUT') }}
                <div class="am-form-group">
                    <label for="user-name" class="am-u-sm-3 am-form-label">评论ID <span class="tpl-form-line-small-title">CommentId</span></label>
                    <div class="am-u-sm-9">
                        <input type="text" class="tpl-form-input" id="user-name" name="cid" value="{{ $comment->cid }}" >
                ...
                <div class="am-form-group">
                    ...
                    <div class="am-u-sm-9">
                        <input type="text" class="tpl-form-input" id="user-name" name="uid" value="{{ $comment->uid }}">
                        <!-- <small>请填写标题文字10-20字左右。</small> -->
                    </div>
                </div>
                ...
                <div class="am-form-group">
                    ...
                    <div class="am-u-sm-9">
                        <input type="text" class="tpl-form-input" id="user-name" name="aid" value="{{ $comment->aid }}">
                        <!-- <small>请填写标题文字10-20字左右。</small> -->
                    </div>
                </div>
               ...
               <!--  <div class="am-form-group">
                ...
                <div class="am-form-group">
                    ...
                    <div class="am-u-sm-9">
                        <input type="text" class="tpl-form-input" id="user-name" name="c_content" value="{{ $comment->c_content }}">
                        <!-- <small>请填写标题文字10-20字左右。</small> -->
                    </div>
                </div>
               ...
               <!--  <div class="am-form-group">
                ...
                <div class="am-form-group">
                    ...
                    <div class="am-u-sm-9">
                        <input type="datetime" class="am-form-field tpl-form-no-bg" value="{{ $comment->c_time }}" name="c_time"  data-am-datepicker="" readonly="" >
                        <!-- <small>发布时间为必填</small> -->
                    </div>
                </div>
